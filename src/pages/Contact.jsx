      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 50% 65% at 80% 0%, rgba(247,147,26,0.06) 0%, transparent 60%)",
          }}
        />
        <div className="container" style={{ position: "relative" }}>
          <FadeIn>
            ...
            >
              ¿Querés ser parte de Bitcoin Week Uruguay? Ya sea como sponsor,
              speaker o simplemente para sumar tu energía, estamos para
              escucharte.
            </p>
          </FadeIn>
        </div>
                    ...
                    <div style={{ marginBottom: 26 }}>
                      ...
                      >
                        {INQUIRY_TYPES.map((t) => (
                          ...
                          >
                            <span style={{ opacity: type === t.id ? 1 : 0.45 }}>
                              {t.icon}
                            </span>
                            {t.label}
                          </button>
                      ...
                      {[
                        ...
                        <div key={f.name}>
                          ...
                          <input
                            ...
                            style={inputStyle}
                            onFocus={(e) =>
                              (e.target.style.borderColor = "var(--btc)")
                            }
                            onBlur={(e) =>
