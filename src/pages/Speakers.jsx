        ...
        >
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    background: 'var(--surface-2)', border: '1px dashed var(--border-hot)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: 'var(--btc)', fontSize: 24, fontFamily: 'var(--font-display)',
                }}>?</div>
                {!speaker.confirmed && (
                    <div style={{
                        position: 'absolute', top: 12, right: 12,
                        background: 'var(--btc-dim)', border: '1px solid var(--btc-line)',
                        borderRadius: 999, padding: '3px 10px', fontSize: 9,
                        fontFamily: 'var(--font-mono)', color: 'var(--btc)', letterSpacing: '0.12em',
                    }}>TBD</div>
                )}
            </div>
            ...
            <div style={{ padding: 22 }}>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 20, letterSpacing: '0.04em', marginBottom: 4, color: 'var(--text-primary)' }}>
                    {speaker.name}
                </h3>
                <p style={{ color: 'var(--btc)', fontSize: 10, fontFamily: 'var(--font-mono)', letterSpacing: '0.12em', marginBottom: 10, textTransform: 'uppercase' }}>
                    {speaker.role}
                </p>
    ...
    return (
        <main style={{ paddingTop: 'var(--nav-h)' }}>
            ...
            <section style={{ background: 'var(--black)', padding: '80px 0 56px', borderBottom: '1px solid var(--border)', position: 'relative', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 55% 80% at 100% 50%, rgba(247,147,26,0.06) 0%, transparent 60%)' }} />
                <div className="container" style={{ position: 'relative' }}>
                    ...
                    <FadeIn delay={0.12}>
                        <div style={{ marginTop: 28, display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
                            <div className="tag"><div className="tag-dot" /> Anuncios próximamente</div>
                            <Link to="/contacto" className="btn-ghost" style={{ fontSize: 11, padding: '7px 16px' }}>
                                Quiero ser speaker
                            </Link>
                        </div>
                    </FadeIn>
                    ...
                    <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
                        {[
                            ...
                            <div key={i}>
                                ...
                                <div style={{ color: 'var(--text-muted)', fontSize: 9, fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.14em' }}>{s.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container" style={{ textAlign: 'center', maxWidth: 560, margin: '0 auto' }}>
                    <FadeIn>
                        <div style={{
                            ...
                            background: 'var(--btc-dim)', border: '1px solid var(--btc-line)',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            color: 'var(--btc)', margin: '0 auto 22px',
                        }}><Mic size={20} /></div>
                        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(32px,5vw,56px)', marginBottom: 14, letterSpacing: '0.03em' }}>
                            ¿QUERÉS SER SPEAKER?
                        </h2>
                        <p style={{ color: 'var(--text-secondary)', fontSize: 14, marginBottom: 28, lineHeight: 1.75 }}>
                            Si tenés algo valioso que aportar al ecosistema Bitcoin uruguayo y latinoamericano, nos encantaría escucharte.
                        </p>
                        <Link to="/contacto" className="btn-primary">Proponer charla</Link>
                    </FadeIn>
                </div>
            </section>
        </main>
